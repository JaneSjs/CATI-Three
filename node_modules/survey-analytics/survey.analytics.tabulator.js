...
/* harmony import */ var _localizationManager__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../localizationManager */ "./src/localizationManager.ts");
/* harmony import */ var tabulator_tables__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tabulator-tables */ "tabulator-tables");
/* harmony import */ var tabulator_tables__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(tabulator_tables__WEBPACK_IMPORTED_MODULE_5__);
...
var styles = __webpack_require__(/*! ./tabulator.scss */ "./src/tables/tabulator.scss");
if (!!document) {
...
var Tabulator = /** @class */ (function (_super) {
        ...
        _this.accessorDownload = function (cellData, rowData, reason, _, columnComponent, rowComponent) {
            if (Array.isArray(_this.data)) {
                ...
                if (!!column && rowComponent) {
                    var dataRow = _this.data[rowComponent.getPosition()];
    ...
    Tabulator.prototype.render = function (targetNode) {
                ...
                config.ajaxRequestFunc = function (url, config, params) {
                    return new Promise(function (resolve, reject) {
                        ...
                        var dataLoadingPromise = _this.data({
                            ...
                            limit: params.size,
                            filter: (_a = _this.tabulatorTables) === null || _a === void 0 ? void 0 : _a.getFilters(),
                            sort: (_b = _this.tabulatorTables) === null || _b === void 0 ? void 0 : _b.getSorters().map(function (s) { return ({ field: s.field, dir: s.dir }); }),
        ...
        this.tabulatorTables = new (tabulator_tables__WEBPACK_IMPORTED_MODULE_5___default())(this.tableContainer, config);
...
/* harmony export */   Tabulator: () => (/* reexport safe */ _tables_tabulator__WEBPACK_IMPORTED_MODULE_17__.Tabulator),
/* harmony export */   TabulatorRow: () => (/* reexport safe */ _tables_tabulator__WEBPACK_IMPORTED_MODULE_17__.TabulatorRow),
/* harmony export */   defaultDownloadOptions: () => (/* reexport safe */ _tables_tabulator__WEBPACK_IMPORTED_MODULE_17__.defaultDownloadOptions),
/* harmony export */   defaultOptions: () => (/* reexport safe */ _tables_tabulator__WEBPACK_IMPORTED_MODULE_17__.defaultOptions),
...
/* harmony import */ var _tables_tabulator__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../tables/tabulator */ "./src/tables/tabulator.ts");
