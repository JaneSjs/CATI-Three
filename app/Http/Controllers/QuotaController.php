...
class QuotaController extends Controller
{
    ...
    public function show($schema_id)
    {
        ...
        $data['total_interviews'] = Interview::where('schema_id', $schema_id)->where('interview_status', 'Interview Completed')->where('quality_control', '!=', 'Cancelled')->whereNotNull('quality_control')->count();
