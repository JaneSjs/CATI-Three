          ...
          <div class="row">
            ...
            <div class="col">
              <div class="mb-3">
                ...
                <input id="male" type="number" name="male_target" class="form-control" placeholder="Male Target Count">
              </div>
              ...
              <div class="mb-3">
                ...
                <input id="female" type="number" name="female_target" class="form-control" placeholder="Female Target Count">
              </div>
