<div class="modal fade" id="assignSpecificMembers" data-coreui-backdrop="static" tabindex="-1" aria-labelledby="assignUsers" aria-hidden="true">
  <div class="modal-dialog modal-xl bg-secondary">
    <div class="modal-content">
      <form method="post" action="{{ route('projects.assign_specific_users', $project->id) }}">
        @csrf
        @method('PUT')
        <div class="modal-header">
          <h5 class="modal-title" id="assignUsers">
            Assign Specific Member(s) To {{ $project->name }}
          </h5>
